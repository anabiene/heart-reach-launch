    ...
    <footer className="bg-card border-t border-border py-12 px-4">
      <div className="container mx-auto">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-foreground">Charity Institution</span>
            </div>
            <p className="text-sm text-muted-foreground">
              Transforming lives through compassion and sustainable community development.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center gap-2 text-muted-foreground">
                ...
                <span>123 Hope Street, City</span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-border pt-8 text-center text-sm text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} Charity Institution. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
